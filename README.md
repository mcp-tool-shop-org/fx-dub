...
| [v2 build brief](docs/briefs/2026-08-21-fxdub-02-brief.md) — corrections + build order for the Comfy Agent | 📨 awaiting relay |
| v2 graphs (cloud + local), host runner, event-timeline spot effects | ⏳ next sessions |
