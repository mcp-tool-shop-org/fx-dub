...
**v1.1.0 — 流水线已交付，两个收据都显示为绿色，并且图像已进行唇形同步。** 一个包含两个角色的夜间街道场景在容器协议（48 kHz、−18.09 LUFS、对话音量高于背景音乐 +11.17 LU，161 帧完整，10.069 秒）中获得了 **19/19** 分，在内容协议中获得了 **11/11** 分。唇形同步的版本保持相同的协议——832 × 480、161 帧、两个音轨——MAC 的嘴巴与他的台词同步，而当画面外的人物说话时，他的嘴是闭着的。
